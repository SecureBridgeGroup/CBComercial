  ...
  return (
    <>
      ...
      <section className="min-h-screen flex flex-col md:flex-row items-center justify-center py-20 px-6 bg-gray-100">
        ...
        {/* Formulário */}
        <div className="w-full md:w-3/5 lg:w-1/2 max-w-4xl mx-auto bg-white rounded-2xl shadow-2xl p-10 relative z-20">
          <h1 className="text-3xl font-bold text-gray-800 mb-2">
            Solicite <span className="text-primary">Um Vendedor</span>
          </h1>
          <p className="text-gray-600 mb-8">Preencha os campos abaixo para solicitar atendimento comercial.</p>
